...
import skynoveau from "../Assets/skynoveau.png";
  ...
  return (
    <div>
      ...
      <div className="title_1">
        <p id="themaking-text" data-aos="fade-up">
          Websino Technology - Premium Website Designing Service Provider with{" "}
        ...
        {/* <div className="img_container">
          <div className="img_main_container">
            ...
            <p data-aos="zoom-out" className={setCnt ? "aft_p" : "pre_p"}>
              Registration is open now for Courses & Internships at an
              Affordable package
            </p>
            <a
              href="#internships"
              data-aos="zoom-out"
              className={setCnt ? "aft_p" : "pre_p"}
            >
      ...
      <div className="newBannerImgContainer">
        <img src={Designer} className="newBannerImg" />
      </div>
      {/* what we do */}
      ...
      {/* our clients */}
      <h2 className="ourClient_main_title" data-aos="fade-up">
        Our clients
      </h2>
      <div className="clients_main_cont">
        <div className="clients_cont">
          ...
          <img src={skynoveau} alt="1" data-aos="fade-up" style={{width:"200px"}} />
        </div>
      </div>
      ...
      <div className="features">
        <ul>
          ...
          <li data-aos="fade-up">
            Clear your doubts even after the course completion
          </li>
      ...
      {/* <div className="class_time">
        <div className="class_time_container">
          <p id="Training" data-aos="fade-up">
            Platform:
          </p>
        ...
        {InternData.map((item, index) => (
          <div className="item_1" key={index} data-aos="fade-up">
            <div className="item_1_container">
              ...
              <a href={item.link}>
                <button>
                  Register Here <HiChevronRight className="item_1_icon" />
                </button>
              </a>
            </div>
          </div>
