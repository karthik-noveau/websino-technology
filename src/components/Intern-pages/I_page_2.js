...
function I_page_2() {
    ...
    return (
        <div>
            {
                count ? (<div className="blur_cont"><Payments amount={Intern_page_Data[1].price} /></div>) : ""
            }

            <div className="detail_container" >
                <div className="detail_main_container">
                    <p className="title_text" data-aos="flip-up">Internship :{Intern_page_Data[1].C_title} </p>


                    {/* image container */}
                    <div className="detail_img_contanier" data-aos="fade-right">
                        <div className="detail_img">
                            <img src={Intern_page_Data[1].image} />
                        </div>
                        <div className="img_txt_container">
                            <p>{Intern_page_Data[1].C_des}</p>
                        </div>
                    ...
                    <div className="description_main_container">
                        <div className="description_container">
                            <div className="offer_container" >
                                ...
                                <ul>
                                    {Intern_page_Data[1].topics.map((itm) => (
                            ...
                            <div className="payment_container" data-aos="fade-left">
                                <div className="pay_main_container">
                                    <img src={payment} />
                                    <p>Rs: ₹{Intern_page_Data[1].price}/-</p>
